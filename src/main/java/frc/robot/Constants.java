...
public final class Constants {
  ...
  public static final class CustomPoseEstimatorConstants {
     public static final double fieldWidth = Units.inchesToMeters(323.28);        // Field width
     public static final double fieldHeight = Units.inchesToMeters(651.2);        // Field height
  }
