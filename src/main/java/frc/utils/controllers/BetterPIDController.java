...
public class BetterPIDController implements Sendable, AutoCloseable {
  ...
  public BetterPIDController(double kp, double ki, double kd, double period) {
    m_kp = kp;
    m_ki = ki;
    m_kd = kd;
   ...
   *
   * @return The velocity (derivative) error.
   */
